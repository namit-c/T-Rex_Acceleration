...
## This is a class used to store the different game sound volumes
def MainMenu():

    ## Defining constant for the maximum volumes
    MAX_VOLUME = 100

    ## Constructor that initializes different sound volumes
    def __init__(self):
        self.__background_music_volume = MAX_VOLUME
        self.__sound_effects_volume = MAX_VOLUME

    ## Method that updates the volume of the game sounds
    ...
    ## Method that returns the current volume levels of the sounds
